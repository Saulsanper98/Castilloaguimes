...
const ESTADO_STYLES: Record<string, { badge: string; btn: string; btnText: string }> = {
  ...
  Completo: {
    ...
    btn: "bg-white/10 text-[#f5f5f0]/60 cursor-not-allowed",
    btnText: "Completo",
  },
  Finalizado: {
    badge: "bg-white/10 text-[#f5f5f0]/60 border border-white/10",
    btn: "bg-white/5 text-[#f5f5f0]/55 cursor-not-allowed",
    btnText: "Finalizado",
  },
}
...
function SpotsBar({ total, occupied }: { total: number; occupied: number }) {
  ...
  return (
    <div>
      <div className="flex justify-between text-xs text-[#f5f5f0]/60 mb-1.5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-14">
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-[#f5f5f0] font-display font-black text-2xl tracking-tight">Próximos Torneos</h2>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1 gap-3">
                    ...
                    <div className="flex items-center gap-4 text-xs text-[#f5f5f0]/60">
              ...
              {past.map((c) => (
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center gap-3 text-xs text-[#f5f5f0]/60 mt-1">
                  ...
                  <span className="shrink-0 text-[10px] font-bold px-2.5 py-1 rounded-full bg-white/10 text-[#f5f5f0]/60">
                    Finalizado
                  </span>
                </div>
              ))}
